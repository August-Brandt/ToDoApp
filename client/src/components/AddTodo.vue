...
<template>
    <section class="bg-green-300 flex justify-center border-t-2 border-green-100">
        <div class="w-sm md:w-lg p-3">
            <form @submit.prevent="addTodo" class="grid grid-cols-1 md:grid-cols-3 gap-2">
